...
<section class="Kb_mission visa_about">
   <div class="Kb_container">
      <div class="kb_row">
...
<button class="tablinks" onclick="openCity(event, 'tab-<?php echo $i ?>')" <?php echo $id ?>><?php echo get_sub_field( "tab_link" ) ?></button>
      <?php   $i++;
        endwhile;
?>
            </div>
      ...
      <div class="Kb_about_video_right">
		...
		$i = 1;
        while ( have_rows('tabs') ) : the_row();
echo '<div id="tab-' . $i . '" class="tabcontent">' . get_sub_field( "tab_content" ) . '</div>';
        $i++;
        endwhile;
		?>  
      </div>
...
<section class="Kb_mission visa_about_bottom">
   <div class="Kb_container">
   <div class="kb_row justify-content-center"> 
         <div class="title_section text-center">
            <h2> <?php echo get_field("assist_title") ?></h2>
         </div> 
   </div>
   <div class="kb_row">
      <div class="Kb_about_content">
         <div class="Kb_about_inner_content">
            <p><?php echo get_field("assist_description") ?></p> 
            <a class="btn-secondary" href="/book-an-appointment/">Get in Touch</a> 
         </div>
      </div>
      <div class="Kb_about_video_right">
         <article class="cb-card">
            <?php echo get_field("assist_right_text") ?>
         </article>
      </div>
   </div>
   </div>
